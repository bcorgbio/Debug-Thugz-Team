...
#CPK: Don't we want to group by date (experiment)? Cycles of fin beat don't span each date. [-1]. So . . .
...
#CPK: rather than compute mean, then se seprately and joining the two, you could've define your SE funciton earlier and computed both at the same time. [-1]. So . . 
...
#CPK: Getting there! Just be sure to make things more concise and provide all the data you need and read it in properly.
