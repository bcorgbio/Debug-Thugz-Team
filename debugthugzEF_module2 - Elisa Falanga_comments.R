...
#CPK: Excellent! But don't we won't amp.sum.mean on the y and bl.s on the x and error bares that reflect amp.sum se, no bl.s? [-1]
...
#CPK: This is excellent! Well done!! I didn't have your data files because you uploaded to google (my mistake---that's how we did things for a while in years past). Sorry about the confusion.
